...
- [The Exosphere Vision](vision.md)

- [Getting Started](getting_started.md)
    - [Installation](installation.md)
    - [Hello World Capsule](hello_world.md)
    - [CLI Toolchain](cli_usage.md)
...
- [Language Reference](lang_ref.md)
    ...
    - [CASM: Assembly & Bytecode](casm.md)

- [Standard Library](stdlib.md)
    - [I/O & Streams](stdlib_io.md)
    - [Filesystem Operations](stdlib_fs.md)
    - [System & Resources](stdlib_system.md)
    - [Networking & IPC](stdlib_net.md)

- [Developer SDKs](sdks.md)
    - [Rust SDK Guide](sdk_rust.md)
    - [Python SDK Guide](sdk_py.md)
    - [FFI & C ABI](sdk_c.md)

- [Tools & Ecosystem](tools.md)
    - [Packman: Package Registry](pacman.md)
    - [Vortex: Interactive Shell](vortex.md)
    - [Teddy: Terminal IDE](teddy.md)

- [Cookbook & Examples](cookbook.md)
    - [Building a Web Service](cookbook_web.md)
    - [Secure Data Processing](cookbook_data.md)
    - [Cross-Language Integration](cookbook_polyglot.md)

- [Branding & Identity](branding.md)
    - [Design System Tokens](design_system.md)
    - [Visual Identity Guide](visual_identity.md)
    - [Logos & ASCII Art](logos.md)

- [Internals & Specifications](internals/README.md)
    - [Memory Model](internals/memory/README.md)
    - [Type System](internals/types.md)
    - [Packaging & Distribution](internals/packaging.md)
